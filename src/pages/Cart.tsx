          ...
          <div className="bg-white p-6 rounded-lg shadow-md sticky top-8 border border-gray-200">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex justify-between">
                ...
                <span className="text-gray-900">Rp {getTotalPrice().toLocaleString('id-ID')}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Ongkos Kirim</span>
                <span className="text-gray-900">Rp 15.000</span>
              </div>
              <div className="border-t pt-2">
                <div className="flex justify-between font-semibold text-lg">
                  <span className="text-gray-900">Total</span>
                  <span className="text-gray-900">Rp {(getTotalPrice() + 15000).toLocaleString('id-ID')}</span>
                </div>
              </div>
            </div>
