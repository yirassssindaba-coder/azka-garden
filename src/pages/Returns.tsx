  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center border-2 border-green-200">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">24 Jam Klaim</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center border-2 border-green-200">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Proses Mudah</h3>
              <p className="text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-green-200">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900">Kondisi yang Dapat Diklaim</h3>
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-green-200">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900">Kondisi yang Tidak Dapat Diklaim</h3>
              </div>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start space-x-2">
        ...
        {/* Return Process */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Proses Pengembalian</h2>
